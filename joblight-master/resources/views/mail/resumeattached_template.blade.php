            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                    ...
                    <td valign="top" style="font-size:14px;font-family:Helvetica,Arial;color:#212121;line-height:24px">
                        <span style="font-size:21px;font-family:Helvetica,Arial">Hi {{$to_name}}</span><br>
                            <span>Thanks for downloading {{$candidate_name}} 's resume from {{ config('app.name') }}.</span><br>                            
                    </td>
                    <td style="width:39px">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
                ...
                <tr>
                    ...
                    <td valign="top" style="font-family:Helvetica,Arial;font-size:14px;color:#212121">
                            <div>
                                Find the applicant's profile attached with this email
                            </div>
                        <div style="font-size:18px">&nbsp;</div>                                                
                    </td>
                    <td style="width:39px">&nbsp;</td>
