...
<header class="stick-top">
	<div class="menu-sec">
		<div class="container">
			...
			<div class="btn-extars">
				<a href="{{URL::to('/employer/postcreate')}}" title="" class="post-job-btn"><i class="la la-plus"></i>Post Jobs</a>
				<ul class="account-btns">					
					<li><a href="{{URL::to('/logout')}}"><i class="la la-external-link-square"></i> SignOut</a></li>
				</ul>
			</div><!-- Btn Extras -->					
			<nav>
				<ul>
					<li class="menu">
						<a href="{{URL::to('/employer/main')}}" title="">Home</a>							
					</li>					
					<li class="menu">
						<a href="{{Route('buycredits')}}" title="">Buy Credits</a>							
					</li>
					<li class="menu">
						<a href="{{URL::to('/employer/talentsearch')}}" title="">Talent Search</a>							
					</li>
					<!-- <li class="menu">
						<a href="#" title="">Interview</a>							
					</li> -->						
					<li class="menu-item-has-children">
						<a href="#" title="">Manage Posts</a>
						<ul>
							<li><a href="{{URL::to('/employer/managejob/draft')}}" title="">Draft Posts</a></li>
							<li><a href="{{URL::to('/employer/managejob/posted')}}" title="">Posted</a></li>
							<li><a href="{{URL::to('/employer/managejob/terminated')}}" title="">Terminated</a></li>
						</ul>
					</li>
					<li class="menu">
						<a href="{{Route('editprofile', $employerprofiles->employer_profile_id)}}" title="">Edit Profile</a>							
					</li>
				</ul>					
			</nav><!-- Menus -->
		</div>
