            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                    ...
                    <td valign="top" style="font-size:14px;font-family:Helvetica,Arial;color:#212121;line-height:24px">
                        <span style="font-size:21px;font-family:Helvetica,Arial">Hi there,</span><br>
                            <span>{{$my_name}} refered a job for you posted in {{ config('app.name') }}.</span><br>
                            <span><i>{{$my_message}}</i></span><br>
                            <span>You're one step away from finding your dream job.</span>
                    </td>
                    <td style="width:39px">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
                ...
                <tr>
                    ...
                    <td valign="top" style="font-family:Helvetica,Arial;font-size:14px;color:#212121">
                            <div>
                                Signup and Apply for the Job 
                            </div>
                        <div style="font-size:18px">&nbsp;</div>                        
                        <table border="0" cellpadding="0" cellspacing="0" bgcolor="#4b42e0" style="border-radius:2px;color:#ffffff;width:300px">
                            <tbody><tr><td style="font-size:9px">&nbsp;</td></tr>                            
                            <tr>
                                <td align="center">
                                        <a style="text-decoration:none;color:#ffffff;font-family:Helvetica,Arial;font-size:18px" href="{{$referral_url}}" target="_blank">
                                            Apply Now via {{ config('app.name') }}
                                        </a>
                                </td>
                            </tr>                            
