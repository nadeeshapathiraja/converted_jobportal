...
<header class="stick-top">
	<div class="menu-sec">
		<div class="container">
			<div class="logo">
				<a href="{{route('mainindex')}}" title=""><img class="hidesticky" src="{{ URL::asset('new/images/logo.png')}}" alt="" /></a>
			</div><!-- Logo -->
			<div class="my-profiles-sec">
				<span><img src='{{ env("AS3_URL").env("AS3_bucket")."/".$userprofile->profile_picture }}' height="50px" width="50px" alt="" /> {{$userprofile->firstname}} {{$userprofile->lastname}} <!-- <i class="la la-bars"> --></i></span>
			</div>
			...
			<nav>
				<ul>
					<li class="menu">
						<a href="{{route('candidatehome')}}" title="">Home</a>							
					</li>
					<li class="menu">
						<a href="{{route('referapplicant', ['mode' => 'applicant'])}}" title="">Refer</a>							
					</li>
					<li class="menu">
						<a href="{{route('jobsearch')}}" title="">Search Jobs</a>							
					</li>
					<!-- <li class="menu">
						<a href="{{route('showinterview')}}" title="">Interview</a>							
					</li> -->
					<li class="menu-item-has-children">
						<a href="#" title="">Job</a>
						<ul>
							<li><a href="{{route('jobsearch', ['applied'])}}">Applied Jobs</a></li>
							<li><a href="{{route('jobsearch', ['shortlisted'])}}">Saved Jobs</a></li>
							<li><a href="{{route('jobsearch', ['recommended'])}}">Recommended Jobs</a></li>								
						</ul>
					</li>						
					<li class="menu-item-has-children">
						<a href="#" title="">My JobKonner</a>
						<ul>
							<li><a href="{{route('candidateviewprofile')}}" title="">View Profile</a></li>
							<li><a href="{{route('candidateviewprofile', ['edit'])}}" title="">Edit Profile</a></li>
							<li><a href="{{route('candidatesettings')}}" title="">Settings</a></li>
...
<div class="profile-sidebar" style="display:none;">
	...
	<div class="can-detail-s">
		<div class="cst"><img src='{{ env("AS3_URL").env("AS3_bucket")."/".$userprofile->profile_picture }}' height="145px" width="145px" alt="" /></div>
		<h3>{{$userprofile->firstname}} {{$userprofile->lastname}}</h3>
		@if(!empty($workexp))
		<span><i>{{$workexp[0]->position}}</i> at {{$workexp[0]->employername}}</span>
		@endif
		<p>{{Session::get('user.email')}}</p>
		<p>Member Since, 2018</p>
		<p><i class="la la-map-marker"></i>{{$userprofile->state}} / {{$userprofile->country}}</p>
	</div>
	<div class="tree_widget-sec">
		<!-- <ul>
			<li class="active">
				<a href="{{route('candidateviewprofile')}}" title=""><i class="la la-file-text"></i>My Profile</a>				
			</li>
			...
			<li><a href="{{URL::to('/logout')}}" title=""><i class="la la-unlink"></i>Logout</a></li>
		</ul> -->
	</div>
</div><!-- Profile Sidebar -->
@stop